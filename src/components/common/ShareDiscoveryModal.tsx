        ...
        const dataUrl = await toPng(el, {
            ...
            filter: (node: HTMLElement) => {
                if (node.nodeType === 1) {
                    ...
                    if (
                        style.includes('oklch(') || style.includes('oklab(') ||
                        style.includes('lch(') || style.includes('lab(')
                    ) {
        ...
        >
            <ModalContent>
                ...
                <ModalBody className="px-6 py-4">
                    ...
                    <div style={{
                        position: 'fixed', top: 0, left: '-1100px',
                        width: '1080px', height: '1920px',
                        opacity: 0, pointerEvents: 'none', zIndex: -1,
                    }}>
                        <ShareDiscoveryCard ref={captureRef} data={data} />
                    </div>
